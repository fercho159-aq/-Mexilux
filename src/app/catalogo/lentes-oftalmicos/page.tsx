/**
 * ═══════════════════════════════════════════════════════════════════════════
 * CATÁLOGO - LENTES OFTÁLMICOS - Apple Style
 * ═══════════════════════════════════════════════════════════════════════════
 */
...
export const metadata: Metadata = {
    title: 'Oftálmicos | Mexilux',
    description: 'Explora nuestra colección de armazones para lentes graduados. Diseño, calidad y confort para tu visión.',
};
...
export default async function LentesOftalmicosPage() {
    const [{ frames, pagination }, brands] = await Promise.all([
        getFrames(
            { status: 'active', categorySlug: 'lentes-oftalmicos' },
            ...
            <section className="catalog-hero" style={{ background: 'linear-gradient(135deg, #2d3436 0%, #636e72 100%)' }}>
                <div className="catalog-hero-content">
                    ...
                    <p className="catalog-hero-subtitle" style={{ color: 'rgba(255,255,255,0.8)' }}>
                        {pagination.total} armazones de diseño para tu receta
                    </p>
                </div>
            </section>
            ...
            <section className="catalog-filter-bar">
                <div className="filter-bar-container">
                    <div className="filter-search">
                        ...
                        <input type="search" placeholder="Buscar armazones..." className="filter-search-input" />
                    </div>
                ...
                <div className="active-filters-bar" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 2rem' }}>
                    ...
                    <Link href="/catalogo" className="active-filter-tag">
                        Oftálmicos <span className="remove-filter">×</span>
                    </Link>
                </div>
            </section>
