...
export const metadata: Metadata = {
    title: 'Lentes Oftálmicos | Mexilux',
    description: 'Descubre nuestra colección de armazones oftálmicos de las mejores marcas. Diseño y calidad mexicana.',
};
...
export default async function LentesOftalmicosPage() {
    // Obtener datos de la base de datos - solo lentes oftálmicos
    const [{ frames, pagination }, brands] = await Promise.all([
        getFrames(
            {
                status: 'active',
                categorySlug: 'lentes-oftalmicos',
            },
    ...
    return (
        <main className="catalog-page">
            ...
            <nav className="breadcrumb" aria-label="Navegación">
                ...
                <span className="breadcrumb-separator">/</span>
                <span className="breadcrumb-current">Lentes Oftálmicos</span>
            </nav>
            ...
            <div className="catalog-container">
                ...
                <aside className="catalog-sidebar" aria-label="Filtros">
                    <div className="sidebar-header">
                        <h2>Filtros</h2>
                        <Link href="/catalogo/lentes-oftalmicos" className="btn-clear-filters">Limpiar todo</Link>
                    </div>
                ...
                <section className="catalog-main" aria-labelledby="catalog-title">
                    <div className="catalog-header">
                        <h1 id="catalog-title">Lentes Oftálmicos</h1>
                    ...
                    <div className="category-banner" style={{
                        ...
                        <div>
                            ...
                            <p style={{ margin: '0.5rem 0 0', opacity: 0.9 }}>
                                Diseño mexicano con materiales de la más alta calidad
                            </p>
                        </div>
                    </div>
                    ...
                    {frames.length === 0 ? (
                        <div className="empty-state" style={{ textAlign: 'center', padding: '4rem 2rem' }}>
                            <p style={{ fontSize: '1.25rem', color: '#6e6e73' }}>
                                No hay lentes oftálmicos disponibles en este momento.
                            </p>
